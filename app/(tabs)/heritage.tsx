...
export default function HeritageScreen() {
  const heritageMedia = MEDIA_DATA.filter((item) => item.category === 'Heritage');
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <Text style={styles.headerTitle}>Heritage</Text>
        <Text style={styles.headerSubtitle}>
          {heritageMedia.length} {heritageMedia.length === 1 ? 'item' : 'items'}
        </Text>
      </View>
